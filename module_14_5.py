...
kb = ReplyKeyboardMarkup(resize_keyboard=True).row(button_1, button_2, button_3, button_4)
...
async def sing_up (message):
    await message.answer('Введите имя пользователя (только латинским алфавитом): ')
